<?php
    ...
    if($user_exp<time()) header("location:password_verify_page.php?error=code expired!");
    else if($code!=$user_code) header("location:password_verify_page.php?error=code invalid!");
    else{
